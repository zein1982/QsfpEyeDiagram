...
{
    /// <summary>
    /// Логика взаимодействия для SecondCdrRxControl.xaml
    /// </summary>
    public partial class SecondCdrRxControl : QsfpEyeDiagramControlBase
    {
        public readonly Channel _channel;
        public SecondCdrRxControl()
        {
            InitializeComponent();
        ...
        private void SlaSliderRx_PreviewKeyUp(object sender, System.Windows.Input.KeyEventArgs e)
        {
        ...
        private void SaveSwing()
        {
            ...
            ViewModel.UtbMonitoringPause();
            ViewModel.WriteCdrSwing((bool)cbMuteForse.IsChecked, (bool)cbDisAutoMute.IsChecked, (byte)OutputSwingSliderRx.Value, _channel, 0);
            ViewModel.UtbMonitoringRelease();
        ...
        {
            ViewModel.SecondChannel.IsOperationCdrSuccessRx = false;
        }
